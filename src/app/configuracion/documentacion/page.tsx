    ...
    <div className={`h-full rounded-3xl border p-6 shadow-sm ${getToneClasses(tone)}`}>
      ...
      <div className="mt-6">
        {href ? (
          ...
          <span className="inline-flex rounded-2xl border border-white/70 bg-white/70 px-4 py-2 text-sm font-bold">
            Referencia interna
          </span>
        )}
      </div>
      ...
      <div className="space-y-8">
        ...
        <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-5 overflow-hidden rounded-2xl border border-slate-100">
            <div className="hidden grid-cols-[160px_1fr_160px] bg-slate-50 px-4 py-3 text-xs font-black uppercase tracking-[0.16em] text-slate-500 md:grid">
              <div>Sprint</div>
              <div>Detalle</div>
              <div>Estado</div>
            </div>
            ...
            <div className="divide-y divide-slate-100">
              {sprintStatuses.map((item) => (
                ...
                >
                  <div>
                    <p className="font-black text-slate-900">{item.sprint}</p>
