...
export const navigation: NavItem[] = [
  ...
  { name: 'Calculadoras', href: '/calculadoras', icon: Calculator, roles: ['admin', 'employee', 'auditor', 'client'], industries: ['legal'], group: 'Herramientas jurídicas', description: 'Herramientas de cálculo para plazos y montos.' },
  { name: 'Modelos', href: '/modelos', icon: FileSignature, roles: ['admin', 'employee', 'auditor', 'client'], industries: ['legal'], group: 'Herramientas jurídicas', description: 'Plantillas y modelos de documentos.' },
